...
public class TestdataFactoryImpl extends EFactoryImpl implements TestdataFactory {
	...
	public static TestdataFactory init() {
		try {
			TestdataFactory theTestdataFactory = (TestdataFactory)EPackage.Registry.INSTANCE.getEFactory("http://testdata/1.0"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TestdataPackage.ROOT: return createRoot();
			case TestdataPackage.PERSON: return createPerson();
			default:
