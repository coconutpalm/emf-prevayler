 ...
 * @generated
 */
public class TransactionmodelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static TransactionmodelPackage modelPackage;
	 ...
	 * @generated
	 */
	public TransactionmodelSwitch() {
		if (modelPackage == null) {
			modelPackage = TransactionmodelPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TransactionmodelPackage.CHANGE_TRANSACTION: {
